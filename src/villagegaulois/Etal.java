...
public class Etal {
	...
	public String libererEtal() throws NullPointerException {
		...
		try {
			...
			return("Etal vide impossible de liberer un etal ");
		}
	...
	public String acheterProduit(int quantiteAcheter, Gaulois acheteur) throws NullPointerException , IllegalArgumentException,IllegalStateException{
		...
		if(quantiteAcheter < 1){
			throw new IllegalArgumentException ("La quantiter acherter :"+quantiteAcheter+" doit etre superieur a 1 \n");
		}

		if (this.etalOccupe == false){
			throw new IllegalStateException ("L'etal n'est pas occuper \n ");
		}
